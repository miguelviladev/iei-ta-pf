...
%%% RESUMO %%%
\begin{abstract}
Neste relatório, vamos vos dar a conhecer mais sobre alguns temas e tópicos relacionados à \ac{ra}, como: o impacto que a sua introdução à sociedade causou, a criação de novos termos para novas realidades tecnologicas e de que maneira podemos experiênciar esta tecnologia no nosso dia a dia.

A necessidade da criação da \ac{ra} e da evolução deste termo ao longo dos anos mostra-nos a vontade do Homem conseguir inovar e moldar o mundo ao seu redor, conseguindo cada vez tirar mais proveito do mesmo. 

E assim, com a evolução da \ac{ra}, ficamos a conhecer, além da sua utilidade, também o seu impacto e as limitações que esta ainda apresenta. Ainda ficamos a conhecer algumas outras novas tecnologias semelhantes, como a \ac{rv}, que mais a frente iremos abordar com mais detalhe e mostrar as diferenças entre as duas tecnologias.

Na atualidade esta tecnologia tem como principal finalidade ajudar e facilitar o dia a dia de certos empregos, tornando-os mais eficientes e diminuindo o tempo dispensado para certa tarefa. No entanto, muita gente já teve contacto com a \ac{ra} através do seu smartphone, através de filtros de fotografias de certas aplicações. Mas para dar a conhecer alguma ferramenta mais específica, iremos abordar a mais recente tecnologia da Mirosoft, os \textit{HoloLens 2}. Este produto, nada mais é que uns Óculos Holográficos é o mais próximo que encontramos de ser a ferramenta ideal para o dia a dia do trabalhador, é funcional, prático e confortável para o uso intensivo durante horas.

Por fim, neste trabalho iremos demonstrar que dificuldades esta tecnologia está a ultrapassar e mostrar as conclusões que tiramos após a nossa pesquisa e estudo sobre o tema.
