...
\section{Conceito}
O conceito de óculos holográficos surgiu exatamente com a criação do conceito de \ac{ra} por Thomas Caudell.
...
Toda esta pesquisa levou ao desenvolvimento de hardware específico para que, de forma intuitiva e prática, fosse possível usar a \ac{ra} como “braço-direito” nas tarefas do quotidiano no trabalho. Assim, empresas como a Epson, a Vuzix, a Solos, a Google, a Microsoft, entre outras, têm vindo a desenvolver óculos que permitem ao utilizador utilizar a \ac{ra} na sua atividade profissional. Com tanta pesquisa e com tantas grandes empresas envolvidas, as opções de equipamentos que permitem visualizar a \ac{ra} são algumas, como os \textit{Google Glasses} e os \textit{HoloLens} porém, neste trabalho iremos dar especial atenção aos óculos produzidos pela Microsoft, os \textit{HoloLens}, o novo e mais recente produto de \ac{ra} que será disponibilizado no mercado para as mais diversas funções, como irá ser referido mais a frente.
...
É apresentado como um produto que chega a todas as idades, para qualquer uso que possamos imaginar e que nos possa ser útil para as mais variáveis situações do quotidiano. Tudo isto junto num equipamento de fácil utilização e tão confortável que nem iremos dar conta de que o estaremos a usar, permitindo conforto para várias horas de uso diiário. Será como ter o nosso \textit{smartphone} embutido nos nossos óculos que nos permitirão fazer e receber chamadas, acessar calendário, metereologia e tudo o resto que um \textit{smartphone} é capaz de fazer nos nossos dias.
